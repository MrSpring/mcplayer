...
public class GuiFancyButton extends Gui
{
	...
	public void drawButton(Minecraft minecraft, int mouseX, int mouseY)
	{
		...
		DrawingHelper.drawRect(this.posX, this.posY, this.width, this.height, Color.BLACK, 0.25F);



		DrawingHelper.drawRect(this.posX, this.posY, this.width, 1F, Color.WHITE, alpha);
		DrawingHelper.drawRect(this.posX, (this.posY + this.height) - 1F, this.width, 1F, Color.WHITE, alpha);

		DrawingHelper.drawRect(this.posX, this.posY, 1F, this.height, Color.WHITE, alpha);
		DrawingHelper.drawRect((this.posX + this.width) - 1F, this.posY, 1F, this.height, Color.WHITE, alpha);
